                ...
                <form id="updatewfm">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                           ...
                           <select id="materialSelect"value="<?php echo e($order->material_no); ?>" name="material_no" class="form-control">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" readonly class="form-control" id="std_pkg"value="<?php echo e($order->std_pkg); ?>" name="std_pkg">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Value MRP Less 50</label>
                            <input type="text" step="0.01" readonly id="value_mrp_less_50" class="form-control"value="<?php echo e($order->value_mrp_less_50); ?>" name="value_mrp_less_50">
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" readonly id="segment" class="form-control"value="<?php echo e($order->segment); ?>" name="segment">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="orderType" name="order_type" class="form-control">
                                ...
                                <option value="Regular" <?php echo e($order->order_type == 'Regular' ? 'selected' : ''); ?>>Regular</option>
                                <option value="Advance" <?php echo e($order->order_type == 'Advance' ? 'selected' : ''); ?>>Advance</option>
                            </select>
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Quantity</label>
                            <input type="number" class="form-control" id="qty" value="<?php echo e($order->qty); ?>" name="qty">
                        </div>
...
let selectedMaterial = "<?php echo e($order->material_no); ?>";
    if (selectedMaterial) {
...
function submitForm() {
    $.ajax({
        url: "/update-order-trail/<?php echo e($order->id); ?>",
        type: "POST",
...
<?php endif; ?><?php /**PATH E:\sanket-project\delux-project\resources\views/order_edit_trail.blade.php ENDPATH**/ ?>