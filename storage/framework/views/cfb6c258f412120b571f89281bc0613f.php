...
<body class="app">   	
		            ...
		            <div class="app-utilities col-auto">
						...
						<div class="app-utility-item app-user-dropdown dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
									...
									<li><a class="dropdown-item"><?php echo e(session('EMP_NAME')); ?></a></li>
    ...
    </header><!--//app-header--><?php /**PATH E:\sanket-project\delux-project\resources\views/components/header.blade.php ENDPATH**/ ?>