								...
								<div class="row g-0 app-auth-wrapper">
									<div class="col-12 col-md-7 col-lg-12 auth-main-col text-center p-5">
										<div class="d-flex flex-column align-content-end">
                                            ...
                                            <form action="<?php echo e(url('/order-upload')); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-3">
...
<?php endif; ?><?php /**PATH E:\sanket-project\delux-project\resources\views/order.blade.php ENDPATH**/ ?>